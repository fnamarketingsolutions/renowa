...
const AboutUs = () => {
  ...
  return (
    <motion.section
      ...
      className="w-full py-12 sm:py-16 md:py-24 overflow-hidden relative z-10 select-none"
    >
      ...
      >
        ...
        {/* TEXT CONTENT CARD CONTAINER (Appears 1st on Mobile, 1st on Desktop) */}
        <motion.div
          initial={{ opacity: 0, x: -40 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, ease: [0.25, 1, 0.5, 1], delay: 0.1 }}
          className="w-full lg:w-[65%] order-1 lg:order-1 relative z-10 mt-6 lg:mt-32"
        >
        ...
        {/* TEAM PHOTO IMAGE (Appears 2nd on Mobile, 2nd on Desktop via negative margins) */}
        <motion.div
          initial={{ opacity: 0, x: 40, scale: 0.98 }}
          animate={{ opacity: 1, x: 0, scale: 1 }}
          transition={{ duration: 0.85, ease: [0.16, 1, 0.3, 1] }}
          className="w-full lg:w-[50%] order-2 lg:order-2 relative z-20 flex justify-end mt-8 lg:mt-0 lg:-ml-[15%] lg:-mt-32 self-start"
        >
          <motion.div
            whileHover={{ scale: 1.01 }}
            transition={{ duration: 0.4, ease: "easeOut" }}
            className="w-full rounded-[24px] shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden p-0"
          >
