        ...
        <div className="hidden lg:flex items-center gap-8">
          <div className="flex items-center gap-6 text-center">
            {[
              ...
              <button key={idx} className="group flex flex-col items-center justify-center min-w-[70px] focus:outline-none">
          ...
          <div className="flex items-center gap-3 pl-2">
            <button className="h-11 bg-[#22a4dd] text-white px-5 rounded-sm text-xs font-bold flex items-center gap-2 hover:bg-sky-600 transition-colors shadow-xs">
              <Mail className="w-4 h-4 shrink-0" />
              <span>メールで問い合わせる</span>
            </button>
            
            <button className="h-11 bg-white text-slate-600 border border-slate-300 px-5 rounded-sm text-xs font-bold flex items-center gap-2 hover:bg-slate-50 transition-colors shadow-xs">
          ...
          <div className="px-4 py-6 space-y-4 max-w-md mx-auto">
            ...
            <div className="grid grid-cols-2 gap-3 pb-4 border-b border-slate-100">
              {[
                ...
                <button key={idx} className="flex flex-col items-start p-2.5 rounded-lg hover:bg-slate-50 text-left w-full">
            ...
            <div className="flex flex-col gap-2.5 pt-1">
              <button className="w-full h-12 bg-[#22a4dd] text-white rounded-md text-xs font-bold flex items-center justify-center gap-2 active:bg-sky-600 transition-colors">
                <Mail className="w-4 h-4" />
                <span>メールで問い合わせる</span>
              </button>
              
              <button className="w-full h-12 bg-white text-slate-700 border border-slate-300 rounded-md text-xs font-bold flex items-center justify-center gap-2 active:bg-slate-50 transition-colors">
